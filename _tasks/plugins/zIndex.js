...
module.exports = function (config) {
    var html = [
        ...
        tmpHtml = '',
        length = config.paths.dev.html.length,
        collector = listdir(config.paths.dev.html),
    ...
    function listdir(dir) {
        ...
        files.forEach(function (file) {
            ...
            var url = absolutePath.substring(absolutePath.indexOf(config.paths.dev.html) + length + 1);
