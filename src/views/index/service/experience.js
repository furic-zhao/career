var jingliData = [{
    ...
    intro: ["2012年加盟360，前期独立负责还是保密项目的百科前端构建、并身兼产品经理，后续主攻百科编辑器，部分功能被百度和互动百科抄袭借鉴。两周内上线移动版百科，协调处理各环节问题，年底获得优秀员工及股票奖励，随后从百科业务部门并入360最大的前端技术团队-WEB平台部/奇舞团。", "2014年派驻安全卫士部门负责360安全卫士VIP会员中心，创造本地debug开发模式，彻底脱离研发环境对客户端的依赖，增加线上一键开启debug，快速定位问题，大大提高客户端内嵌WEB的研发效率。同时协调支持微密（内嵌web）、悄悄(内嵌web)、手机卫士(活动)、流量卫士（官网）、免费wifi（官网）、点睛平台（官网）、体验中心（官网）等项目。", "2015年初调入老周带领的智能硬件部门，负责360第一个直播项目小水滴直播网站的搭建研发、app内嵌H5、商城官网的各种合作发售活动前端技术支持。后续协助开发3663Mi玩、悟空TV、游戏内嵌秀场以及花椒直播、熊猫TV、等直播项目。"],
    grade: ["主要业绩：", "360搜索百科整体项目规划、前端构建、百科编辑器(ueditor内核)。部分后端PHP模块构建(相关词条模块、词条引用模块)、内容获取(phpQuery)、内容处理(htmlPurifier)，分类系统、自媒体系统等", "安全卫士会员中心、360VIP会员积分商城(Window8优惠码、网易明信片、我买网世界杯、唯品会、随身wifi4G版、当当网电子书、防丢卫士(1/2/3/4期)、当当网服装、天猫电器城、网易花田币、天猫双十一、电脑专家超级预约、有道双重礼包、当当网双十二活动、360安全路由等众多特权项目)。", "微密内嵌页、悄悄内嵌页、手机卫士活动、流量卫士官网、免费wifi官网、点睛平台前端、体验中心全站。", "智能摄像机项目的商城官网、小水滴直播全站（多终端web）、APP内嵌H5、花椒直播播放器/聊天长连、3663Mi玩全站构建/送礼系统、等项目的PC及H5网站架构、项目协调和研发。"]
}, {
    title: "2007~2012",
